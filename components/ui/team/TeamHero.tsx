...
export const TeamHero = () => {
  return (
    <section
      className={`${styles.container} flex justify-center items-center h-[100vh] w-full container`}
    >
      <div className="lg:w-7/12 mx-auto flex flex-col items-center px-20">
        <h2 className="text-[40px] md:text-[64px] mb-4  font-race text-center lg:h-[200px]">
          TraitForge {' '}
        ...
        <motion.p
          ...
          className="text-center font-monserat text-lg md:text-2xl"
        >
