...
export const Aging = () => {
  return (
    <section className="container w-9/12 flex justify-end mt-[100px]">
      <div className="relative border px-10 py-[30px] bg-gradient-to-tr to-light-blue from-light-dark border-light-blue rounded-md  after:h-[101px] after:w-0.5 after:bg-primary after:-translate-y-full after:absolute after:top-0 after:left-20 w-10/12 before:-translate-y-1/2 xl:gap-x-[70px] before:h-3 before:w-3 before:rounded-full before:bg-primary before:absolute before:top-0 before:left-[75px]   ">
