    ...
    return (
        <div className="flex flex-row content-center justify-center">
            <div className="flex w-8/12 flex-col items-center text-center justify-center">
                ...
                <h1 className="headers border text-4xl mt-4 mb-6"> DISCOVER THE </h1><h1 className={`headers text-4xl ml-2 mt-4 mb-6 ${styles.span}`}> ART COLLECTION</h1>
                </div>
            ...
            <img className="svg-buttons" onClick={openArtPage} type="image/svg+xml" src="/images/explore.svg" width="350" height="100" />
            </div>
