...
const Gameplay = () => {
    ...
    return (
        <div className='h-screen w-screen flex flex-col items-center'>
            ...
            There are a total of 10 Generations,
            which can be minted in parallel via a breeding mechanism. 
            ...
            The maximum total NukeFactor is 50% - ie, a single nuke can claim 50% of all ETH in the Fund. 
            Entities move from their initial Nuke Factor (set randomly) towards the maximum with a speed
            dictated by Performance Factor (set randomly). Some mature faster than others, with the fastest maturing in around 30 days,
            and slowest 600 days. 
